            ...
            <div class="section-content">
                <table border="0" cellpadding="0" cellspacing="0" class="tbl-col-join">
                    ...
                    <form enctype="multipart/form-data">
                        <input value="<?= $row['id'] ?>" id="lecture-id" type="hidden" class="input-text" style="width:302px"/>
                        <tr>
                            <th scope="col"><span class="icons">*</span>강의 제목</th>
                            <td><input id="title" value="<?= $row['title'] ?>" type="text" class="input-text" style="width:302px"/></td>
                        </tr>
                        <tr>
                            <th scope="col"><span class="icons">*</span>강사 이름</th>
                            <td><input id="teacher" value="<?= $row['teacher'] ?>" type="text" class="input-text" style="width:302px"/></td>
                        </tr>
                        <tr>
                            <th scope="col"><span class="icons">*</span>학습 난이도</th>
                            <td><input id="level" value="<?= $row['level'] ?>" type="text" class="input-text" style="width:302px" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input id="newMainPhoto" type="file" class="input-text" style="width:302px"/></td>
                        </tr>
                        <tr>
                ...
                <div class="box-btn">
                    <button class="btn-l" id="modify-btn" type="button">수정</button>
                </div>
            </div>
