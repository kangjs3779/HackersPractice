...
<div class="login-section">
    ...
    <div class="login-inner">
        <h1><a href="/"><img src="http://img.hackershrd.com/common/logo.png" alt="해커스 HRD LOGO" width="142"
                             height="31"/></a></h1>
        <div class="box-login">
...
<!--                <form action="/practice/process/loginProcess.php" method="post">-->
            ...
            <div class="login-chk">
                ...
                <label class="input-privacy on">보안접속 ON <input type="checkbox"
                                                               title="IP 보안이 켜져 있습니다. IP보안을 사용하지 않으시려면 선택을 해제해주세요."/></label>
        ...
        <div class="login-banner">
            <div class="bxslider-default" data-mode="fade" data-auto="true" data-controls="true" data-pager="true"
                 style="height:182px">
                <ul class="bxslider">
                    <li>
                        <img src="http://www.champstudy.com/files/banner/imglib_files/banner/imglib/300freepass_620x400.jpg"
                             alt="" width="262" height="182"/></li>
                    <li>
                        <img src="http://www.champstudy.com/files/banner/imglib_files/banner/imglib/champstudy_first_toeic_class_620x400.jpg"
                             alt="" width="262" height="182"/></li>
                    <li>
                        <img src="http://www.champstudy.com/files/banner/imglib_files/banner/imglib/teps0freepass_620x400.jpg"
                             alt="" width="262" height="182"/></li>
                    <li>
                        <img src="http://www.champstudy.com/files/banner/imglib_files/banner/imglib/2nd_foreign_620x400.jpg"
                             alt="" width="262" height="182"/></li>
                </ul>
            </div>
        </div>
